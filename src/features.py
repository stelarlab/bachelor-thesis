...
# v4-final feature set (24 features): aggregated cluster statistics.
# Strip-by-strip variants (v5-v7) did not help -- v4 is the XGBoost limit.
#   removed vs. v1 (correlation > 0.95):
#     q_right_frac, x_max, t_span, q_max
#   removed vs. v2 (fit artefact):
